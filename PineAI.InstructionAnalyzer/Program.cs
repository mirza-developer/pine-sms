...
Console.WriteLine("=== PineAI Instruction Analyzer ===");
Console.WriteLine();
...
var instructionFilePath = config["InstructionFilePath"] ?? "../PineAI.BaleBot/Chat/chtbot-instructions-main.md";
...
var optionsBuilder = new DbContextOptionsBuilder<PineAIDbContext>();
...
using (var dbContext = new PineAIDbContext(optionsBuilder.Options))
{
