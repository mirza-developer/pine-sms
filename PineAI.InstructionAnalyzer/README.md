...
This console application analyzes chat messages between users and the PineAI chatbot, then automatically improves the bot's instruction file by applying high-impact enhancements identified by an LLM.
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Data Source=../PineAI.BaleBot/bot.db"
  },
  ...
  "InstructionFilePath": "../PineAI.BaleBot/Chat/chtbot-instructions-main.md",
  "HistoryDirectory": "../PineAI.BaleBot/Chat/history"
}
```
