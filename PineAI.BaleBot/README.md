...
`PineAI.BaleBot` continuously polls the [Bale Bot API](https://dev.bale.ai) (`tapi.bale.ai`) for incoming messages using long-polling (`getUpdates`).  
...
1. Edit (or add a new `*.md` file to) `PineAI.BaleBot/Chat/`.
